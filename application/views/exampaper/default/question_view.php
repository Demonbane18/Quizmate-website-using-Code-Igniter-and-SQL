	...
	<ul class="box-header nav nav-tabs">
		<li class="pull-left header">
			<i class="fa fa-file-o"></i> <?php 
				echo "<span class=\"question-labelno\">Question</span> <span class=\"question-no\">$number</span>";
			?>
		</li>
	</ul>
	<div class="box-body">
		...
		<div class="question-choices-label">
			<div class="col-md-8">
				<?php
					...
					$enabled = true;
					echo form_label('Answer <span class="text-danger">*</span>', 'answer['.$question_id.']');
	...
	<div class="question-choices-label">
		<div class="col-md-5">
			<div class="form-group">'.
				form_label('Answer <span class="text-danger">*</span>', 'answer['.$question_id.']').
				form_input($inputops).
			'</div>
		</div>
	</div>
