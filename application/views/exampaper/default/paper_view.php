<div class="fullpaper">
	<div class="row">
		<div class="col-md-6"><?php echo <<<html
			<h4 style="display: inline-block;">Quiz of subjects</h4> $courseData[code] $courseData[name]<br>
			<p style="padding-left: 10px">
				<b><u>Description</u></b><br>
				$paperData[description]<br>
				<b><u>Quiz/ Quiz rules</u></b>
				<br> $paperData[rules]
			</p>
html;
?>		</div>
		<div class="col-md-6" style="text-align: right;">
			<?=$this->misc->getFullDateT( date('Y-m-d') );?><br>
			Time <?=$paperData['starttime'];?> - <?=$paperData['endtime'];?><br><br>
			<b><u>Teacher</u></b><br>
