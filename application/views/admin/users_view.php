...
<aside class="right-side">
	...
	<section class="content">
		<h4 class="page-header">
			<small>You can manage all groups of users, such as admins, teachers, and students.</small>
		</h4>
		...
		<div class="box">
			<div class="box-body">
				...
				<div class="btn-group">
					...
					anchor('admin/users/viewgroup/teacher', 'Teacher', 'class="'.$this->misc->btnActive($group,'teacher').'"').
