	...
	<div class="box-footer" style="display: none;">
		<div class="row">
			<div class="col-md-12 text-right">
				<span class="text-muted">created <?php
		...
		<div class="row">
			<div class="col-md-12 text-right">
				<?php
					switch ($status) {
						case 'active':
							echo '<span class="text-success jtooltip" title="Ready for quiz set"><b>Available/b></span>';
							break;
						case 'inactive':
							echo '<span class="text-muted jtooltip" title="temp unavailable"><b>Unavailable</b></span>';
							break;
						case 'inuse':
							echo '<span class="text-primary jtooltip" title="Already used in the quiz set cannot be changed"><b>Applied</b></span>';
							break;
						case 'draft':
							echo '<span class="jtooltip" title="Not used"><b>Draft</b></span>';
							break;
						default:
