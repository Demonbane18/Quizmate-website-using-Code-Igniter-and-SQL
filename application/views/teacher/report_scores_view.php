				...
				<table class="table table-striped table-hover textvertmid rowclick">
					<thead>
						<tr>
							...
							<th style="width: 88px;">Initial</th>
							<th style="width: 80px;" class="">Open quiz(number)</th>
						</tr>
					</thead>
					<tbody>
					<?php
						if ($courseslist) {
							foreach ($courseslist as $item) {
								...
								<td class="status">
									<div class="btn-group">
										<a href="{$this->misc->getHref('teacher/reports/bypaper')}/{$item['course_id']}" class="btn btn-sm btn-default btn-flat">Classified by quiz set</a>
