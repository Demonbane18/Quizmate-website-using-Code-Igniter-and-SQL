...
<aside class="right-side">
	...
	<section class="content-header">
		<h1>
			<span class="fa fa-rss"></span> Quiz subject
			<small></small>
		</h1>
		<ol class="breadcrumb">
			<li><?php echo anchor('teacher', '<i class="fa fa-dashboard"></i> Main Pahe');?></li>
			<li class="active">Quiz subject</li>
		</ol>
	</section>
		...
		<div class="box box-info nav-tabs-custom">
			<ul class="nav nav-tabs  pull-right">
				...
				<li class="pull-left header">
					<i class="glyphicon glyphicon-th"></i> List of exam subjects
				</li>
			</ul>
